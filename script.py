...
def graficar_soluciones(soluciones):
    if soluciones is not None:
        ...
        # Crear un gráfico de barras para visulaizar las soluciones
        ...
        print("No se pueden generar el grafico debido a la falta de soluciones.")
